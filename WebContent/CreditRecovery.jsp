...
<title>Ifill : Credit Recovery</title>
	...
	$(document)
			...
			return json;
					...
					$('#submit_row').click(function(){
						...
						if(custId.length < 1 || !$.isNumeric(custId) || amount.length < 1 || !$.isNumeric(amount)  || date.length < 1){
							alert('Please enter valid values before submitting.');
						}else{
							//alert('submiting');
							//alert(JSON.stringify($('#creditRecovery').serializeObject()));
							$.ajax({
								type : "POST",
								url : $('#creditRecovery').attr('action'),
								data : JSON.stringify($('#creditRecovery').serializeObject()),
					...
					function proceed(response) {
						...
						var key = "readingsGrid"+readings+ KEY_SEPERATOR +custId+ KEY_SEPERATOR +date;
		...
		$('#logoutButton').click(function(e){
			...
			function deleteRow(e){
						...
						$.ajax({
							type : "DELETE",
							url : "/ifill/inventory/"+key+"/deleteCreditRecovery",
							contentType : 'application/json',
							dataType : "text",
							success : function(status) {												
	...
	<table width="1003" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="263" height="40" align="left"
				...
				class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Credit Recovery</td>
			<td width="740">&nbsp;</td>
		</tr>
	</table>
	<div class="container">
		<div class="row clearfix">
			...
			<form action="/ifill/inventory/postCreditRecovery" method="POST" id="creditRecovery" >
				<table class="table  table-striped" >
					
					<tbody>
						<tr id='addr0'>
							<td></td>
							<td><div class="col-md-offset-4 col-md-6"><label for='customerId' class='col-md-3 control-label'>CustomerId </label></div></td>
							<td><div class="col-md-offset-1 col-md-10">
									<input type="text" id='customerId' name='customerId' class="form-control" /></div></td>
							<td><div class="col-md-offset-4 col-md-6"><label for='product' class='col-md-3 control-label'>Date</label></div></td>
							<td><div class="col-md-offset-1 col-md-10"><input type="text" class="form-control datepicker" placeholder='Report Date' id="date" name="date"  data-date-format="dd-mm-yyyy"/></div></td>
							<td><div class="col-md-offset-4 col-md-6"><label for='saleInRs' class='col-md-3 control-label'>Amount</label></div></td>
							<td><div class="col-md-offset-1 col-md-10"><input type="text" id='saleInRs' name='saleInRs' placeholder='Rupees' class="form-control" /></div></td>
						</tr>
						<tr id='addr1'></tr>
					</tbody>
				</table>
