...
<title>Ifill : Add Credit Customer</title><link href="${pageContext.request.contextPath}/css/datepicker.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<table width="1003" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="263" height="40" align="left"
				style="background-image: url(${pageContext.request.contextPath}/images/report_button.png); background-repeat: no-repeat"
				class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;New Credit Customer</td>
			<td width="740">&nbsp;</td>
		</tr>
	</table>
	<div class="container">
					...
					<tbody>
						<tr id='addr0'>
							...
							<td><div class="col-md-offset-1 col-md-10">
									<input type="text" id='ldsale' class="form-control" />
									<input type="hidden" id='effcSaleLtrs' name="effcSaleLtrs" class="form-control" />
								</div>
							</td>
							<td><div class="col-md-offset-1 col-md-10">
									<input type="text" id='ldsalers' class="form-control" />									
								</div>
							</td>
						</tr>
						<tr id='addr1'></tr>
