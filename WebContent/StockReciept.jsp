	...
	$(document)
			...
			return json;
				...
				$('#submit_row').click(function(){
						//alert('submiting');
						//alert(JSON.stringify($('#stockReciept').serializeObject()));
						var product = $('#product').val();
						var quantity = $('#quantity').val();
						var date = $('#date').val();
						
						if(product == "XXX" || quantity.length < 1 || !$.isNumeric(quantity) || date.length < 1){
							alert('Please fill all valid values before submitting.');
						}else{
						
							$.ajax({
								type : "POST",
								url : $('#stockReciept').attr('action'),
								data : JSON.stringify($('#stockReciept').serializeObject()),
					...
					function proceed(response) {
						...
						//alert(readings);
						var key = "readingsGrid"+readings+ KEY_SEPERATOR +product+ KEY_SEPERATOR +date;
		...
		$('#logoutButton').click(function(e){
			...
			function deleteRow(e){
						...
						$.ajax({
							type : "DELETE",
							url : "/ifill/inventory/"+key+"/deleteStockReciept",
							contentType : 'application/json',
							dataType : "text",
							success : function(status) {												
	...
	<table width="1003" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="263" height="40" align="left"
				...
				class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stock Reciept</td>
			<td width="740">&nbsp;</td>
		</tr>
	</table>
	<div class="container">
		<div class="row clearfix">
			...
			<form method="POST" id="stockReciept" action="/ifill/inventory/postStockReciept">
				<table class="table  table-striped" >
					...
					<tbody>
						<tr id='addr0'>
							...
							<td><div class="col-md-offset-4 col-md-6"><label for='product' class='col-md-3 control-label'>Quantity</label></div></td>
							<td><div class="col-md-offset-1 col-md-10"><input type="text" id='quantity' name='quantity' size="25" placeholder='Liters' class="form-control" /></div></td>
						</tr>
						<tr id='addr1'></tr>
					</tbody>
				</table>
	...
	<div class="container">
		<div class="row clearfix">
			...
			<table ><tr><td class="col-md-offset-1 col-md-10"></td>
						...
						<td class="col-md-offset-1 col-md-10"></td>
						<td class="col-md-offset-1 col-md-10"></td>
						<td><a id='backbutton' href="/ifill/ifill/inventory/showHomePage" class="pull-right btn btn-default">Go Back</a></td></table>
			</div>
		</div>
	</div>
