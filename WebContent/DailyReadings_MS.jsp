...
<title>Ifill : DailyReadings MS</title>
						...
						if($.isNumeric(val)){
							...
							$.ajax({
								...
								success : function(ldr) {
									...
									//alert($('#pumpId').val());
									//ifill/ifill/metadata/MS/itemprice
									// get the price
									$.ajax({
										type : "GET",
...
<body>
	...
	<table width="1003" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="263" height="40" align="left"
				style="background-image: url(${pageContext.request.contextPath}/images/report_button.png); background-repeat: no-repeat"
				class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DailyReadings MS</td>
			<td width="740">&nbsp;</td>
		</tr>
	</table>
	<div class="container">
				...
				<table class="table table-bordered table-striped" >
					...
					<tbody>
						<tr id='addr0'>
							...
							<td><div class="col-md-offset-1 col-md-10">
									<input type="text" id='ldsalers' size="25" disabled="disabled"  class="form-control" />
