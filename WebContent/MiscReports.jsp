	...
	$(document)
			...
			return json;
				...
				$('#submit_row').click(function(){
					...
					function proceed(){
						//alert('success');
						window.location.href = "/ifill/reports/showSalesReport";
					}
...
<body>
	...
	<div class="container">
		<div class="row clearfix">
			...
			<form method="POST" id="showReport" action="/ifill/reports/showReport">
				<table class="table  table-striped" >
					
					<tbody>
						<tr id='addr0'>
							<td></td>
							<td><div class="col-md-offset-4 col-md-6"><label for='type' class='col-md-3 control-label'>Report_Type</label></div></td>
